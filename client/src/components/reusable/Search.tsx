...
const Search = () => {
  ...
  return (
    <div className="bg-primary2 w-fit flex flex-row text-white space-x-2 px-5 items-center">
      {/* Search by name or adress .... */}
      <div className="relative">
        <input
          onChange={(e) => dispatch(setQuery(e.target.value.toLowerCase()))}
          value={query}
          type="text"
